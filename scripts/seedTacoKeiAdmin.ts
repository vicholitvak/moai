// scripts/seedTacoKeiAdmin.ts
// Script para crear el perfil TacoKei con menú completo personalizable usando Firebase Admin
// Usage: npx tsx scripts/seedTacoKeiAdmin.ts
...
async function seedTacoKei() {
  ...
  try {
    ...
    const cookRef = await db.collection('cooks').add(tacoKeiProfile);
    ...
    console.log('\n🔗 Puedes ver los platos en: http://localhost:3000/client/home');
